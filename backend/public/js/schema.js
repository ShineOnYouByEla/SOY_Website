  ...
  },
  {
    ...
    fields: [
      ...
      { k: "teaser", label: "Sprechblase am Knopf", type: "text", note: "Leer lassen, wenn keine erscheinen soll." },
      {
        ...
        type: "number",
        note: "Auf dem Handy. Der Kanal-Hinweis oben hat Vorrang, aber höchstens 10 Sekunden lang.",
      },
      {
        k: "autoOpen",
        label: "Chatfenster am Rechner einmal automatisch öffnen",
        type: "checkbox",
        note: "Nur auf breiten Bildschirmen und nur einmal je Besucher:in. Auf dem Handy erscheint stattdessen die Sprechblase.",
      },
      {
        k: "autoOpenDelay",
        label: "Automatisch öffnen nach … Sekunden",
        type: "number",
        note: "Wer vorher über den Startbereich hinausscrollt, sieht es schon nach 5 Sekunden.",
      },
